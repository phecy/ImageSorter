...
<<<<<<< HEAD
Various publications such as \citeauthor{Bhattacahrya:2010:FPA:1873951.1873990}\cite{Bhattacahrya:2010:FPA:1873951.1873990} and \citeauthor{Kopf:2008:DPM:1409060.1409069}\cite{Kopf:2008:DPM:1409060.1409069} have focused on improving the quality of an image thech is the second step of the Photographer's Process%.\cite{Bhattacahrya:2010:FPA:1873951.1873990}\cite{Kopf:2008:DPM:1409060.1409069};
=======
...
>>>>>>> a0182f7b109dd2ec524e3af49c149a2b8b9a959b
...
Previous works in general image quality assessment have explored single features such as blur \citeauthor{springerlink:10.1007/978-3-540-77409-9_26}\cite{springerlink:10.1007/978-3-540-77409-9_26}, exposure \citeauthor{5540170}\cite{5540170}, color harmony \citeauthor{COL:COL5080160410}\cite{COL:COL5080160410} \citeauthor{COL:COL10004} \cite{COL:COL10004}, and duplicates \citeauthor{Chu2010256} \cite{Chu2010256}. %User tags on Flickr and online search engines have provided sets of similar images to compare\cite{Berg:EECS-2007-13}\cite{Chu2010256}. 
Several papers have developed methods for separating professional and amateur photographs such as \citeauthor{springerlink:10.1007/978-3-540-30541-5_25} \cite{springerlink:10.1007/978-3-540-30541-5_25}, \citeauthor{springerlink:10.1007/11744078_23} \cite{springerlink:10.1007/11744078_23}, \citeauthor{1640788} \cite{1640788}, \citeauthor{springerlink:10.1007/978-3-540-88690-7_29} \cite{springerlink:10.1007/978-3-540-88690-7_29}. %Unlike our work, these assume a finalized image. 
The methods for image retrieval are not as useful for image removal because they assume a finalized photograph, rather than looking at the potential to be enhanced- or, more simply, they focus on aesthetic quality over technical quality. Removal of technically flawed photographs, as opposed to aesthetically unpleasing ones, is more readily automated without consideration of personal preference. We consider color harmony a technical aspect because it can be indicative of probems with lighting and color blanace.
...
First, we use the timestamp to obtain a similarity index between all pairs of images. Based on an algorithm which finds gaps \cite{1292402}, which finds gaps in timestamps, we have derived a formula which finds temporal closeness between two images:
\[
T_{i,j}=\frac{G}{A_g}
\]
