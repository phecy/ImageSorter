...
\[
\frac{1}{R}\left(\displaystyle\sum\limits_{i=1}^n\left(W_i\sqrt[3]{{Q_i*t}^2}\right)\right)^3
\]
...
\caption{Examples of \subref{example_blur},\subref{example_expose} low quality and \subref{example_good} high-quality images. The dots are interest points found; the square is the bounding box considered to be the subject. Despite the too-large box in \subref{example_expose}, each algorithm worked properly.}
\label{fig:Examples}
\end{figure*}
